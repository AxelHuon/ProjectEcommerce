...
class Order extends \App\Entity\Order implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Order' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Order' . "\0" . 'user', '' . "\0" . 'App\\Entity\\Order' . "\0" . 'orderItems', '' . "\0" . 'App\\Entity\\Order' . "\0" . 'totalPrice', '' . "\0" . 'App\\Entity\\Order' . "\0" . 'status', '' . "\0" . 'App\\Entity\\Order' . "\0" . 'address'];
        }
     ...
     * {@inheritDoc}
     */
    public function setTotalPrice(float $totalPrice): \App\Entity\Order
    {
     ...
     * {@inheritDoc}
     */
    public function setAddress(?\App\Entity\Address $address): \App\Entity\Order
    {
