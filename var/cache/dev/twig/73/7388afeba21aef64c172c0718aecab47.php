...
class __TwigTemplate_0882888680c47bb0924d416f42c693d3 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  147 => 40,  140 => 36,  133 => 32,  115 => 16,  107 => 13,  104 => 12,  102 => 11,  99 => 10,  93 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<form method=\"post\">
    ...
    <div class=\"login-box\">
        ...
        <div class=\"form-row forgot-password\">
            <a href=\"{{ path('app_forgot_password_request') }}\">Forogot Password ?</a>
        </div>
        ...
        <div class=\"form-row-btn\">
            <button class=\"btn-custom btn-black\"  type=\"submit\">Sign in</button>
            <button class=\"btn-custom btn-black\" type=\"button\"  onclick=\"window.location.href='{{ path('app_register') }}'\">Register</button>
        </div>
    </div>

</form>
{% endblock %}
", "security/login.html.twig", "/Users/axelhuon/Documents/Projet/ProjectEcommerce/templates/security/login.html.twig");
    }
}
