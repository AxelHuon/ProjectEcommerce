...
class __TwigTemplate_e5430eef43a1d91bce22277f4cd5fe8f extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        echo "
            ...
            <button class=\"btn-custom btn-black\">Send password reset email</button>
        ";
        // line 22
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["requestForm"]) || array_key_exists("requestForm", $context) ? $context["requestForm"] : (function () { throw new RuntimeError('Variable "requestForm" does not exist.', 22, $this->source); })()), 'form_end');
        echo "
    </div>
";
    ...
    {
        return array (  123 => 22,  111 => 13,  107 => 12,  102 => 9,  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "reset_password/request.html.twig", "/Users/axelhuon/Documents/Projet/ProjectEcommerce/templates/reset_password/request.html.twig");
    }
}
